        ...
        <div className="movie-details-container">
          <div className="movie-details">
            <div className="movie-details-content">
              ...
              <p className="movie-details-info">
                <span className="movie-details-info-label">TMDB Rating:</span>{" "}
                {propsData.vote_average}/10
              </p>
            </div>

            <div className="movie-details-image">
              <img
                src={`https://image.tmdb.org/t/p/w500/${propsData.poster_path}`}
                alt="Movie Poster"
              />
              <a
                className="play-icon"
      ...
      <div className="similar-tv-shows">
        ...
        <div className="tv-shows-list">
          {similarMovie.slice(0, 6).map((responseData) => (
            <Link
              to={`/series-details/${responseData.id}`}
              state={responseData}
              key={responseData.id}
