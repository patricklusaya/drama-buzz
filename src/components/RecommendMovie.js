...
// import {waveSVG} from  '../images/wave.svg'
 class RecommendMovie extends Component {
    ...
    handleSubmit = (e)=>{
        e.preventDefault()
        const {title,releaseDate,description,wonOscar,movieImage} =this.state;
        const movieCollection = collection(db, "movies");
        const movieImagesFolderRef =  ref(storage, `movieImagesFolder/${movieImage.name}`);
